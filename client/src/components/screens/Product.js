...
export const Product = ({ match }) => {
  ...
  let countArray = [...Array(product.countInStock).keys()];
  let countPropertiesArray = countArray.map((count) => ({
    label: count,
    value: count,
  }));
  console.log("countarray", countArray);
  console.log("proparra", countPropertiesArray);
  const [qty, useQty] = useState(countPropertiesArray);
