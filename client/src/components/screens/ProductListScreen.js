  ...
  return (
    <>
      <div className="flex justify-self-end max-w-7xl">
        <button onClick={createProductHandler} className=" bg-green-500 active:bg-green-700 flex ml-auto p-2 text-white font-bold rounded-md mb-2">Product 
              ...
              <tbody className="divide-y divide-gray-200">
                {products.map(({ _id, name, price, category, brand, image, countInStock }) => (
                  <tr key={_id}>
                    ...
                    <td className="px-6 py-4 text-center">
                      <Link className="px-1" to={`/admin/product/${_id}/edit`}>
